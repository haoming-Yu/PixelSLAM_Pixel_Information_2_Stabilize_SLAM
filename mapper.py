...
class Mapper(object):
    ...
    def get_mask_from_c2w(self, c2w, depth_np):
        ...
        ones = np.ones_like(points[:, 0]).reshape(-1, 1) # extract the points number
        # If the points has n points
        # Then the ones will be a (n, 1) matrix with all the elements filled with 1.
